...
public class OrderCancelDisplay extends javax.swing.JFrame {
    ...
    private ArrayList<TradeableDTO> ordersToCancel;
    ...
    public void setVisible(String product, ArrayList<TradeableDTO> orders) {
        setTitle("Cancel Order " + product);
        ordersToCancel = orders;

        ((DefaultListModel) orderList.getModel()).clear();
        for (TradeableDTO trd : orders) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (Integer selection : results) {
            TradeableDTO t = ordersToCancel.get(selection);
            try {
                marketDisplay.getUser().submitOrderCancel(t.product, t.side, t.id);
            } catch (UserCommandException | MessagePublisherException | UserNotConnectedException | InvalidConnectionIdException | InvalidMarketStateException | NoSuchProductException | InvalidMessageException | OrderNotFoundException | InvalidVolumeException | ProductBookSideException | ProductServiceException | ProductBookException ex) {

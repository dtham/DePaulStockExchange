...
public class MarketDisplay extends javax.swing.JFrame {
    ...
    MarketDisplay(User u, UserDisplayManager udm) {
        ...
        } catch (UserCommandException | UserNotConnectedException | InvalidConnectionIdException ex) {
    ...
    private void symbolComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_symbolComboActionPerformed
        ...
        } catch (UserCommandException | PriceException | ProductServiceException | IllegalArgumentException | InvalidPriceOperation | UserNotConnectedException | InvalidConnectionIdException | MessagePublisherException ex) {
            Logger.getLogger(MarketDisplay.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        } catch (PriceException | PositionException | InvalidPriceOperation ex) {
          Logger.getLogger(MarketDisplay.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            switch (ae.getActionCommand()) {
                ...
                case "Cancel Quote":
                    ...
                    } catch (UserCommandException | MessagePublisherException | InvalidVolumeException | UserNotConnectedException | InvalidConnectionIdException | InvalidMarketStateException | NoSuchProductException | InvalidMessageException | ProductBookSideException | ProductBookException | ProductServiceException ex) {
                        Logger.getLogger(MarketDisplay.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    break;
                case "Enter Order":
                ...
                case "Cancel Order":
                    ...
                    } catch (UserCommandException | UserNotConnectedException | InvalidConnectionIdException | ProductBookSideException | ProductBookException | ProductServiceException ex) {
                      Logger.getLogger(MarketDisplay.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    break;
